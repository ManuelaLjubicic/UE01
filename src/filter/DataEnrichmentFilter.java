...
public abstract class DataEnrichmentFilter<in, out>  extends AbstractFilter<in, out> implements Runnable {
    ...
    public DataEnrichmentFilter(IPullPipe<in> input, IPushPipe<out> output) throws InvalidParameterException {
        super(input, output);
    }

    public DataEnrichmentFilter(IPullPipe<in> input) throws InvalidParameterException {
        super(input);
    }

    public DataEnrichmentFilter(IPushPipe<out> output) throws InvalidParameterException {
        super(output);
    }
